    ...
    <div class="space-y-6">
      <div class="relative">
        ...
        <img 
          ...
          alt="Generated image"
          class="w-full rounded-lg shadow-md aspect-[4/3] object-cover bg-gray-100"
        />
        <button 
          @click="downloadImage"
          :disabled="downloading || loading || !imageUrl || isUpdatingPrompt"
          class="btn btn-secondary absolute bottom-4 right-4 flex items-center justify-center gap-2"
        >
          <span 
            v-if="downloading" 
      ...
      <div class="space-y-4">
        <div class="bg-gray-50 rounded-lg p-4">
          ...
          <textarea
            ...
            class="input h-[120px] resize-none"
            placeholder="Edit your prompt..."
            :disabled="isUpdatingPrompt || loading || downloading"
          ></textarea>
        </div>

        <div v-if="promptHistory.length > 0" class="bg-gray-50 rounded-lg p-4">
          <h3 class="text-sm font-medium text-gray-700 mb-2">Prompt History:</h3>
          <div class="space-y-2 h-[100px] overflow-y-auto">
            <div 
